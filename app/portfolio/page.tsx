...
const technologies = ["React", "Next.js", "TypeScript", "Node.js", "Tailwind", "Python", "Flutter", "Rust"]

const projects = [
  {
    title: "Pixel Perfect Editor",
    description: "A modern pixel art editor with real-time collaboration features and custom brush support.",
  ...
  },
  {
    ...
    description: "Beautiful weather application with animated transitions and accurate forecasts.",
    image: "/placeholder.svg",
    categories: ["Mobile"],
  ...
  },
  {
    ...
    description: "High-performance data visualization library with support for large datasets.",
    image: "/placeholder.svg",
    categories: ["Library"],
  ...
  },
  {
    ...
    description: "Efficient task management system with real-time updates and team collaboration features.",
    image: "/placeholder.svg",
    categories: ["Web"],
  ...
  },
  {
    ...
    description: "Real-time system monitoring dashboard with beautiful visualizations.",
    image: "/placeholder.svg",
    categories: ["Desktop"],
  ...
  },
  {
    ...
    description: "A collection of beautiful and accessible UI components for modern web applications.",
    image: "/placeholder.svg",
...
export default function PortfolioPage() {
  ...
  const filteredProjects = projects.filter((project) => {
    const matchesCategories =
      selectedCategories.length === 0 || selectedCategories.some((category) => project.categories.includes(category))
    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-background dark:from-pink-950/20 pb-12">
      ...
      <div className="container py-8 md:py-12">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">A collection of my projects and experiments</p>
        </div>
      </div>
      ...
      <section className="sticky top-16 z-40 border-b bg-background/80 backdrop-blur-sm">
        <div className="container py-4">
          ...
          <div className="space-y-2 mt-4">
            <h2 className="text-sm font-medium text-muted-foreground">Technologies</h2>
            <div className="no-scrollbar flex gap-2 overflow-x-auto pb-2">
                  ...
                  <div className="flex gap-2">
                    <Button variant="ghost" size="icon" className="h-8 w-8" asChild>
                      <Link href={project.demoUrl}>
                        ...
                        <span className="sr-only">Visit demo</span>
                      </Link>
                    </Button>
                    <Button variant="ghost" size="icon" className="h-8 w-8" asChild>
