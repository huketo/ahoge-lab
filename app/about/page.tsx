...
const timeline = [
	{
		...
		title: "The Beginning",
		description:
			"Started the journey into the world of programming and anime.",
		icon: Star,
	},
	{
		year: "2021",
	...
	},
	{
		...
		description:
			"Built a community of like-minded developers and anime fans.",
		icon: Heart,
	},
	{
		year: "2024",
...
export default function AboutPage() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-pink-50 to-background dark:from-pink-950/20">
					...
					<div className="space-y-6">
						...
						>
							...
							<p className="mt-4 text-xl text-muted-foreground">
								A curious researcher, programmer, and anime
								enthusiast with an ahoge that points towards
								adventure! 🌟
							</p>
						</motion.div>
				...
				>
					<div className="relative z-10">
						<p className="text-xl font-medium italic md:text-2xl">
							&ldquo;In the intersection of technology and
							creativity, we find the most fascinating
							discoveries. Let&apos;s explore them
							together!&rdquo;
						</p>
			...
			<section
				ref={timelineRef}
				className="container space-y-8 py-12 md:py-24"
			>
